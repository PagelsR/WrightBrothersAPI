...
namespace WrightBrothersApi.Controllers
{
    ...
    public class AirfieldsController : ControllerBase
    {
        private static List<Airfield> airfields = new List<Airfield>
        {
            ...
            new Airfield("Huffman Prairie", "Ohio", "1904-1905", "First practical airplane flights"),
            new Airfield("Simms Station", "Ohio", "1904-1905", "First airplane passenger flights")
        };
